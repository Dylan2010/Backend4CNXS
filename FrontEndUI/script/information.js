...
$(document).ready(function(e) {
	...
	$.each(infoData,function(n,v){
		/*<li class="odd">
                ...
                <div class="article">
                	<h2>大数据，网络文学的寻龙诀</h2>
                    <p>（北京讯）1月13日，北京，郎朗读书声不仅敲响了2017的新年钟声，还拉开了数舟（上海）数据信息服务有限公司承办的《大数据来了，网络文学如何炼成大IP》主题访谈会的序幕</p>
                </div>
            </li>*/
...
var testData=[
	{
		...
		"imgUrl" : {"1":"./images/news/information/img1.jpg"},
		"type" : "information",
	},
	{
		...
		"imgUrl" : {"1":"./images/news/information/img2.jpg"},
		"type" : "information",
	}
]